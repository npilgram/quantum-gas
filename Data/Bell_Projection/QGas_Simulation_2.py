...
g,T,E,CV,M,Chi,ED,DV=Temperature_Iteration(T_i, T_f, N_Temps, N, max_vel_temp, tau, Interaction, Movement=Movement, Decoherence_type=Decoherence_type, gas_shape=[int(gas_shape_y),int(gas_shape_x)], Temperature=T_i, Seed_Bell_States=Seeded_Bell_States, Number_Seeded_Bell_States=N_Seeded_Bell_States)

np.savetxt(File_Name,(T,E,CV,M,Chi,ED,DV))
